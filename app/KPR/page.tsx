...
const PRODUCTS = [
  ...
  {
    id: "prod-3",
    name: "KPR 2026 Premium Journal",
    category: "Keep-Sakes",
    description: "Classic A5 hardcover prayer journal and planner with custom gold foil styling to preserve your revelations and prayers.",
    image: "/kpr13.jpg",
    price: 8500,
    badge: "Essential",
              ...
              <SlideIn key={product.id} direction="up" delay={0.15 + i * 0.1}>
                <div className="bg-white/5 border border-white/10 rounded-3xl p-5 hover:border-white/20 transition-all duration-300 flex flex-col h-full group">
                  ...
                  <div className="flex-grow flex flex-col">
                    ...
                    {/* Size Selector */}
                    <div className="mb-6">
                      <p className="text-white/40 text-[10px] font-bold uppercase tracking-wider mb-2">Size</p>
                      <div className="flex flex-wrap gap-2">
                        {product.sizes.map((s) => (
                          <button
                            key={s}
                            onClick={() => setSelectedSizes(prev => ({ ...prev, [product.id]: s }))}
                            className={`min-w-[32px] h-8 px-2 rounded-lg text-xs font-extrabold border flex items-center justify-center transition-all ${
